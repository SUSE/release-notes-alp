...
{productname}{nbsp}{this-version} is a description.
...
{productname}{nbsp}{this-ga} has a 13-year life cycle, with 10 years of General Support and 3 years of Extended Support.
The current version ({this-sp}) will be fully maintained and supported until 6 months after the release of {productname}{nbsp}{this-ga}{nbsp}{next-sp}.
